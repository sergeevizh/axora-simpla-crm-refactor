...
<div class="pagination">
	...
	{if $current_page_num==2}
		<a class="prev_page_link" href="{url page=null}">‹ назад</a>
		{$prev="{url page=null}" scope=root}
	{/if}
	{if $current_page_num>2}
		<a class="prev_page_link" href="{url page=$current_page_num-1}">‹ назад</a>
	...
	{if $current_page_num<$total_pages_num}
		<a class="next_page_link" href="{url page=$current_page_num+1}">вперед ›</a>
