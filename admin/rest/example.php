...
<form method="post">
	...
	<p>
		<label>URL</label><br>
		<input type="text" size="100" name="url" value="<?php if(isset($_POST['url']))print $_POST['url']; else print "http://axora".dirname($_SERVER['REQUEST_URI'])."/products/"; ?>">
	</p>
	<p>
		<label>Body:</label><br>
