        ...
        <div id="currencies">
            {foreach $currencies as $c}
                <ul class="sortable {if !$c->enabled}invisible{/if} {if $c->cents == 2}cents{/if}">
                    ...
                    <li class="iso">
                        <input list="iso_currencies" name="currency[code][{$c->id}]" type="text" value="{$c->code|escape}"/>
                    </li>
                    <li class="rate">
                        {if !$c@first}
                            <div class=rate_from>
            ...
            <ul id="new_currency" style='display:none;'>
                ...
                <li class="iso">
                    <input list="iso_currencies" name="currency[code][]" type="text" value=""/>
                </li>
                <li class="rate">
                    <div class=rate_from>
                    ...
                    <div class=rate_to>
                        = <input name="currency[rate_to][]" type="text" value="1"/> {$currency->sign|escape}
                    </div>
                </li>
                <li class="icons">
