...
<form method="post" id="product" enctype="multipart/form-data">
	...
	<div id="name">
		<input placeholder="" class="name" name="name" type="text" value="{$group->name|escape}"/>
	...
	<div id="column_left">
		...
		<div class="block">
			<ul>
				<li>
					<label for="discount" class="property">Скидка</label>
					<input id="discount" name="discount" class="simpla_inp" type="text" value="{$group->discount|escape}"/>%
				</li>
			</ul>
		</div>
