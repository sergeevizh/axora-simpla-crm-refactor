...
function Image_Resize($file, $size, $jpg_quality)
{
    ...
    // Neue Bildgr��e und Typ ermitteln
    list($width_orig, $height_orig, $type) = @getimagesize($file);

    // Neue Bildgr��e und Typ brechnen
        ...
        case 1:
            if (ImageTypes() & IMG_GIF) {
                ...
                if ($trnprt_indx >= 0) {
                    ...
                    $trnprt_indx = @imagecolorallocate($image_p, $trnprt_color['red'], $trnprt_color['green'],
                        $trnprt_color['blue']);
